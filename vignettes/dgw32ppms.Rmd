...
With fplscrapR, we can get that list in juts a few lines of code:
...
df %>% 
  ...
  select(playername,pp90) %>% # selecting player name and ppm for our table
  arrange(-pp90) %>% # ordering (arranging) by ppm
